...
const Icons = {
  ...
  Tooth: () => (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M4.2 12.5C4 11 4 9 6 6c2-3 5-4 8-1 2 2 4 4 4 6 0 5-6 9-6 9s-6-4-7.8-7.5Z" />
      <path d="M12 21a11 11 0 0 1-2-11" />
    </svg>
  ),
  Phone: () => (
    <svg
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 shadow-sm transition-all">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        <a
          href="#inicio"
          className="flex items-center gap-2 text-sky-600 group"
        >
          <Icons.Tooth />
          <span className="text-2xl font-bold text-slate-800 tracking-tight">
            Vital<span className="text-sky-500">Smile</span>
          </span>
        </a>

        <div className="hidden md:flex items-center gap-8 font-medium text-slate-600">
          <a href="#inicio" className="hover:text-sky-600 transition-colors">
            Inicio
          </a>
          <a
            href="#tratamientos"
          ...
          <a href="#equipo" className="hover:text-sky-600 transition-colors">
            Especialistas
          </a>
          <a href="#pacientes" className="hover:text-sky-600 transition-colors">
            Pacientes
          </a>
        </div>
        ...
        <div className="hidden md:flex">
          <a
            href="#agenda"
            className="bg-sky-500 hover:bg-sky-600 text-white px-6 py-2.5 rounded-full font-semibold shadow-lg shadow-sky-500/20 transition-all flex items-center gap-2 transform hover:scale-105"
          >
            <Icons.Calendar />
      ...
      {isOpen && (
        <div className="md:hidden absolute top-20 left-0 w-full bg-white border-b border-slate-100 p-4 shadow-xl flex flex-col gap-4 animate-fade-in">
          ...
          <a
            href="#agenda"
            className="bg-sky-500 text-white px-4 py-3 rounded-xl text-center font-bold"
            onClick={() => setIsOpen(false)}
          >
            Agendar Turno
          </a>
...
const Hero = () => (
  <section
    id="inicio"
    className="relative pt-20 pb-32 bg-linear-to-b from-slate-50 to-white overflow-hidden"
  >
    <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-12 items-center">
      <div className="space-y-8 z-10">
        ...
        <h1 className="text-5xl md:text-6xl font-bold text-slate-900 leading-[1.1] animate-fade-in-up delay-100">
          ...
          <span className="text-transparent bg-clip-text bg-linear-to-r from-sky-500 to-teal-400">
            excelencia médica.
          </span>
        </h1>
        <p className="text-xl text-slate-600 max-w-lg leading-relaxed animate-fade-in-up delay-200">
          Experiencia odontológica sin dolor, enfocada en la estética y salud a
          largo plazo. Tu bienestar es nuestra prioridad.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up delay-300">
          <a
            href="#agenda"
            className="bg-slate-900 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-black transition-all flex justify-center items-center gap-2"
          >
          ...
          <a
            href="#tratamientos"
            className="px-8 py-4 rounded-xl font-semibold text-lg text-slate-600 border border-slate-200 hover:bg-slate-50 transition-all text-center"
          >
            Ver Tratamientos
          </a>
        </div>
      ...
      <div className="relative animate-fade-in delay-500">
        <div className="aspect-4/5 md:aspect-square bg-sky-100 rounded-[2.5rem] overflow-hidden relative shadow-2xl transform hover:scale-[1.01] transition-transform duration-500">
          <img
            src="/images/imagen-hero.jpg"
            alt="Descripción de tu hero"
    ...
    <div className="container mx-auto px-4">
      <div className="text-center max-w-2xl mx-auto mb-16">
        ...
        <p className="text-slate-600 text-lg">
          Un enfoque integral para cada etapa de tu salud bucal, con tecnología
          de vanguardia.
        </p>
      </div>
        ...
        {[
          {
            ...
            desc: "Soluciones definitivas con materiales de titanio biocompatible para recuperar tu masticación.",
          },
          {
            title: "Ortodoncia Invisible",
            desc: "Alineadores transparentes (Invisalign) para corregir tu sonrisa discretamente y sin dolor.",
          },
          {
            title: "Estética Dental",
            desc: "Diseño de sonrisa digital, carillas de porcelana y blanqueamiento láser.",
          },
          {
            title: "Odontopediatría",
            desc: "Atención especializada y amigable para niños y adolescentes.",
          },
          {
            title: "Endodoncia",
            desc: "Tratamientos de conducto con microscopía para salvar tu diente natural.",
          },
          {
            title: "Urgencias 24hs",
            desc: "Guardia activa para dolor agudo, infecciones o traumatismos dentales.",
          },
        ].map((item, idx) => (
          <div
            key={idx}
            className="group p-8 rounded-2xl bg-slate-50 hover:bg-white border border-slate-100 hover:border-sky-100 hover:shadow-xl hover:shadow-sky-500/10 transition-all duration-300"
          >
            ...
            <div className="mt-4 pt-4 border-t border-slate-100">
              <a
                href="#agenda"
                className="text-sky-600 text-sm font-semibold hover:underline flex items-center gap-1"
              >
      ...
      <div className="container mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-slate-600">
            Haz clic en nuestros profesionales para ver su trayectoria.
          </p>
        </div>
          ...
          {doctors.map((doc) => (
            ...
            >
              <div className="relative mb-6 rounded-3xl overflow-hidden shadow-lg mx-auto max-w-xs aspect-4/5 bg-slate-100">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-slate-900/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6">
                  <span className="text-white bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-full text-sm font-medium">
                    Ver Biografía
                  </span>
                </div>
              </div>
              <h3 className="text-2xl font-bold text-slate-900 mb-1 group-hover:text-sky-600 transition-colors">
                {doc.name}
              </h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
            <div className="bg-white rounded-3xl p-8 max-w-2xl w-full relative shadow-2xl flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-2/3 space-y-4">
                ...
                <button
                  onClick={() => setSelectedDoctor(null)}
                  className="mt-4 bg-sky-500 text-white px-6 py-2 rounded-xl font-bold hover:bg-sky-600 transition-colors"
                >
                  Cerrar Ficha
                </button>
              </div>
...
const Testimonials = () => {
  const reviews = [
    {
      name: "Sofía Herrera",
      text: "Increíble la atención. Me hice un tratamiento de conducto y no sentí absolutamente nada de dolor. ¡Súper recomendados!",
      stars: 5,
    },
    {
      name: "Miguel Ángel",
      text: "Llevo a mis hijos desde hace 3 años y los adoran. La paciencia de la Dra. Gómez es única. Gracias por todo.",
      stars: 5,
    },
    {
      name: "Lucía P.",
      text: "Me hice el diseño de sonrisa y el resultado superó mis expectativas. Ahora sonrío en todas las fotos.",
      stars: 5,
    },
  ];
    ...
    <section id="pacientes" className="py-24 bg-sky-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto relative bg-white p-12 rounded-[3rem] shadow-xl transition-all duration-300">
          <div className="absolute top-8 left-8 text-sky-200 opacity-50">
            <Icons.Quote />
          </div>
          ...
          <div className="flex justify-center gap-4 mt-8">
            <button
              onClick={prevReview}
              className="p-2 rounded-full bg-slate-100 hover:bg-sky-100 text-slate-600 hover:text-sky-600 transition-colors"
            >
              <Icons.ChevronLeft />
            </button>
            <button
...
const AppointmentSection = () => {
  ...
  const changeMonth = (increment: number) => {
    ...
    if (newDate < new Date(todayObj.getFullYear(), todayObj.getMonth(), 1))
      return;
    ...
    >
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
                <h4 className="font-bold mb-2 flex items-center gap-2">
                  <Icons.MapPin /> Consultorio Central
                </h4>
                <p className="text-slate-400 text-sm">
                  Av. Colón 5000, Córdoba Capital.
                </p>
              </div>
              <div className="bg-slate-800/50 p-6 rounded-2xl border border-slate-700">
                <h4 className="font-bold mb-2 flex items-center gap-2">
                ...
                <p className="text-slate-400 text-sm">
                  ¿Urgencias? Llámanos al (351) 155-1234
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Interactive Widget */}
          <div className="bg-white rounded-2xl p-6 md:p-8 text-slate-900 shadow-2xl shadow-sky-900/50 min-h-137.5 flex flex-col relative overflow-hidden">
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center h-full animate-fade-in-up">
                ...
                <p className="text-slate-500 text-center mb-6">
                  Fecha: {selectedDate} de {monthNames[month]}
                  <br />
              ...
              <>
                ...
                {/* Time Slots */}
                <div
                  className={`space-y-3 transition-all duration-300 ${selectedDate ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4 pointer-events-none absolute bottom-0"}`}
                >
...
const ContactForm = () => {
  ...
  const validate = () => {
    ...
    if (!formData.phone.trim()) {
      ...
      // Elimina no-dígitos antes de testear
          ...
          {status === "success" ? (
            <div className="text-center py-10 animate-fade-in">
              ...
              <p className="text-slate-500 mb-6">
                ...
                {formData.name || "te responderemos pronto"}.
              </p>
              <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div className="space-y-1">
                ...
                {errors.message && (
                  <p className="text-red-500 text-xs flex items-center gap-1 ml-1">
                    <Icons.Alert /> {errors.message}
                  </p>
                )}
              </div>
              <button
                disabled={status === "loading"}
                className="w-full bg-slate-900 text-white py-4 rounded-xl font-bold hover:bg-black transition-all flex justify-center items-center gap-2"
              >
...
const Footer = () => (
  <footer className="bg-white border-t border-slate-200 py-12 text-center">
    <p className="text-slate-500">
      © 2024 VitalSmile Clínica Dental. Córdoba, Argentina.
    </p>
  </footer>
);
